...
for index, column in enumerate(df):
    ...
    labelMonth.place(x=10, y=(index*120)+0,width=150, height=30)
    labelMean.place(x=10, y=(index*120)+20,width=150, height=30)
    labelStd.place(x=10, y=(index*120)+40,width=150, height=30)
    labelMin.place(x=10, y=(index*120)+60,width=150, height=30)
    labelMax.place(x=10, y=(index*120)+80,width=150, height=30)
