...
for column in df:
    ...
    labelMean.place(x=30, y=0,width=150, height=30)
    labelStd.place(x=60, y=0,width=150, height=30)
    labelMin.place(x=90, y=0,width=150, height=30)
    labelMax.place(x=120, y=0,width=150, height=30)
