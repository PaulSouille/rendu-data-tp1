...
def clear_data(array,month):
        for index,data in enumerate(array, start=1):
            ...
            if(index < len(array)):
                if(not is_float_try(array[index+1])):
            ...
            if(index > 1):
                ...
                if(index == 16):
                    print("Différece avant : " + str(abs(previous-float(current))))
                    print("Différece après : " + str(abs(next_-float(current))))

                    print("Index : " + str(index))
                    print("Précedent : " + str(previous))
                    print("Suivant : " + str(next_))

                    if(abs(next_-float(current)) > 15):


                if(not is_float_try(data) or abs(previous-float(current)) > 15 or abs(next_-float(current)) > 15):
                    print(str(average))
                        print("CHEH")
