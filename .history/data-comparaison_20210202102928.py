...
for index,df in enumerate(array_df):
    ...
    for index_, column in enumerate(df):
        canvas.create_text(100,((index+1*300)*3)+((index_+1)*20)+50,fill="black",font="Times 15 bold",
                            text="Mois : "+str(column))
        canvas.create_text(100,((index+1*300)*3)+((index_+1)*20)+50,fill="black",font="Times 10",
