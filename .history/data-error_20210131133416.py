...
for index, column in enumerate(df_error):
    canvas.create_text(300,(index*120)+20,fill="black",font="Times 15 bold",
                        text="Mois : "+str(column))
    canvas.create_text(300,(index*120)+40,fill="black",font="Times 10",
                            text="Moyenne : "+str(df[column].mean()))
    canvas.create_text(300,(index*120)+60,fill="black",font="Times 10",
    text="Ecart type : "+str(df[column].std()))
    canvas.create_text(300,(index*120)+80,fill="black",font="Times 10",
    text="Minimum : "+str(df[column].min()))
    canvas.create_text(300,(index*120)+100,fill="black",font="Times 10",
    text="Maximum : "+str(df[column].max()))
