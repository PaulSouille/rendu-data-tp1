...
for index,df in enumerate(array_df):
    ...
    for index_, column in enumerate(df):
        canvas.create_text(400+(index*300),(index*120)+((index_+1)*20)+50,fill="black",font="Times 15 bold",
                            text="Mois : "+str(column))
        canvas.create_text(400+(index*300),(index*120)+((index_+1)*20)+50,fill="black",font="Times 10",
                                text="Moyenne : "+str(df[column].mean()))
        canvas.create_text(400+(index*300),(index*120)+((index_+1)*20)+50,fill="black",font="Times 10",
        text="Ecart type : "+str(df[column].std()))
        canvas.create_text(400+(index*300),(index*120)+((index+1)*20)+50,fill="black",font="Times 10",
