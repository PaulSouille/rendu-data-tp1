...
for index,df in enumerate(array_df):
    ...
    for index_, column in enumerate(df):
        canvas.create_text(400,10+(index_+1)*100,fill="black",font="Times 15 bold",
                            text="Mois : "+str(column))
        canvas.create_text(400,40+(index_+1)*100,fill="black",font="Times 10",
        ...
        canvas.create_text(400,80+(index_+1)*100,fill="black",font="Times 10",
                text="Minimum : "+str(df[column].min()))
        canvas.create_text(400,100+(index_+1)*100,fill="black",font="Times 10",
