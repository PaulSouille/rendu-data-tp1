...
for index, column in enumerate(df):
    ...
    canvas.create_text(10,(index*120)+0,fill="black",font="Times 10",
                        text="Mois : "+str(column))
    canvas.create_text(10,(index*120)+20,fill="black",font="Times 10",
                            text="Moyenne : "+str(df[column].mean()))
    canvas.create_text(10,(index*120)+40,fill="black",font="Times 10",
    text="Ecart type : "+str(df[column].std()))
    canvas.create_text(10,(index*120)+60,fill="black",font="Times 10",
    text="Minimum : "+str(df[column].min()))
    canvas.create_text(10,(index*120)+80,fill="black",font="Times 10",
    text="Maximum : "+str(df[column].max()))


    labelMonth.place(x=10, y=(index*120)+0,width=200, height=30)
    labelMean.place(x=10, y=(index*120)+20,width=200, height=30)
    labelStd.place(x=10, y=(index*120)+40,width=200, height=30)
    labelMin.place(x=10, y=(index*120)+60,width=200, height=30)
    labelMax.place(x=10, y=(index*120)+80,width=200, height=30)
