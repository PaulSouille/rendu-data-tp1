...
for index, column in enumerate(df):
    ...
    labelMonth.place(x=0, y=(index*100)+0,width=150, height=30)
    labelMean.place(x=0, y=(index*100)+20,width=150, height=30)
    labelStd.place(x=0, y=(index*100)+40,width=150, height=30)
    labelMin.place(x=0, y=(index*100)+60,width=150, height=30)
    labelMax.place(x=0, y=(index*100)+80,width=150, height=30)
