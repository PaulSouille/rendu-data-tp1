...
for index,df in enumerate(array_df):
    canvas.create_text(400+(index_+1*80),20,fill="black",font="Times 15 bold",
                            text=array_csv[index])

    for index_, column in enumerate(df):
        canvas.create_text(400,50+(index_+1)*80,fill="black",font="Times 15 bold",
                            text="Mois : "+str(column))
        canvas.create_text(400,80+(index_+1)*80,fill="black",font="Times 10",
                                text="Moyenne : "+str(df[column].mean()))
        canvas.create_text(400,110+(index_+1)*80,fill="black",font="Times 10",
