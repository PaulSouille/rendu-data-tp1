...
for index,df in enumerate(array_df):
    ...
    for index_, column in enumerate(df):
        canvas.create_text(((index)*400),10+(index_+1)*100,fill="black",font="Times 15 bold",
                text="Mois : "+str(column))
        canvas.create_text(((index)*400),30+(index_+1)*100,fill="black",font="Times 10",
                text="Moyenne : "+str(df[column].mean()))
        canvas.create_text(((index)*400),50+(index_+1)*100,fill="black",font="Times 10",
                text="Ecart type : "+str(df[column].std()))
        canvas.create_text(((index)*400),70+(index_+1)*100,fill="black",font="Times 10",
                text="Minimum : "+str(df[column].min()))
        canvas.create_text(((index)*400),90+(index_+1)*100,fill="black",font="Times 10",
