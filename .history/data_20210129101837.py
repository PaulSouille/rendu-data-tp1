...
for column in df:
    ...
    labelMean.place(x=0, y=0,width=150, height=80)
    labelStd.place(x=0, y=0,width=150, height=130)
    labelMin.place(x=0, y=0,width=150, height=180)
    labelMax.place(x=0, y=0,width=150, height=230)
