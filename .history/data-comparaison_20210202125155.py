...
for index,df in enumerate(array_df):
    ...
    for index_, column in enumerate(df):
        ...
        canvas.create_text(100+(index*300),20+(index_+1)*110,fill="black",font="Times 10",
                text="Moyenne : "+str(df[column].mean()))
        canvas.create_text(100+(index*300),40+(index_+1)*120,fill="black",font="Times 10",
                text="Ecart type : "+str(df[column].std()))
        canvas.create_text(100+(index*300),60+(index_+1)*130,fill="black",font="Times 10",
                text="Minimum : "+str(df[column].min()))
        canvas.create_text(100+(index*300),80+(index_+1)*140,fill="black",font="Times 10",
                text="Maximum : "+str(df[column].max()))
        canvas.create_text(100+(index*300),100+(index_+1)*150,fill="black",font="Times 10",
...
canvas.create_text(100+(index*300),120+(index_+1)*160,fill="black",font="Times 15 bold",
