...
for index, column in enumerate(df_error):
    clear_data(df_error[column],month)
    canvas.create_text(500,(index*120)+20,fill="black",font="Times 15 bold",
                        text="Mois : "+str(column))
    canvas.create_text(500,(index*120)+40,fill="black",font="Times 10",
                            text="Moyenne : "+str(df_error[column].mean()))
    canvas.create_text(500,(index*120)+60,fill="black",font="Times 10",
    text="Ecart type : "+str(df_error[column].std()))
    canvas.create_text(500,(index*120)+80,fill="black",font="Times 10",
    text="Minimum : "+str(df_error[column].min()))
    canvas.create_text(500,(index*120)+100,fill="black",font="Times 10",
...
b.place(x=700, y=20, anchor="nw", width=150, height=30)
