...
for column in df:
    ...
    labelMean.place(x=0, y=20,width=150, height=30)
    labelStd.place(x=0, y=40,width=150, height=30)
    labelMin.place(x=0, y=60,width=150, height=30)
    labelMax.place(x=0, y=80,width=150, height=30)
